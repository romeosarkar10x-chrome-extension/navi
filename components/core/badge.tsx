...
const TONES: Record<Tone, string> = {
  ...
  success:
    'bg-[rgba(var(--signal-success-rgb),0.14)] text-success border-[rgba(var(--signal-success-rgb),0.35)]',
  progress:
    'bg-[rgba(var(--signal-progress-rgb),0.14)] text-progress border-[rgba(var(--signal-progress-rgb),0.35)]',
  error:
    'bg-[rgba(var(--signal-error-rgb),0.14)] text-error border-[rgba(var(--signal-error-rgb),0.35)]',
