...
export function ChatMessage({ role = 'assistant', children, meta, initials = 'JD', className = '', ...rest }: ChatMessageProps) {
  const isUser = role === 'user';
  return (
    <div className={cn('flex gap-[9px] animate-msg-in', isUser && 'flex-row-reverse', className)} {...rest}>
      <Avatar kind={isUser ? 'user' : 'navi'} initials={initials} size="sm" />
