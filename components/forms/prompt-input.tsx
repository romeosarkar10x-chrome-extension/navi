  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        <IconButton icon="plus" size="sm" label="Attach context" onClick={onAttach} />
        <button type="button" className={MODEL_CLS} onClick={onModelClick}>
        ...
        <button
          ...
          aria-label="Send"
        >
          <Icon name="arrow-up" size={17} strokeWidth={2.25} />
        </button>
      </div>
    </div>
  );
